...
<script src="{{asset('public/ckeditor/ckeditor.js')}}"></script>
	...
	<div class="row">
		<div class="col-xs-12">
		    ...
		    @endif
			{{Form::open(array('url'=>'admin/post/edit','class'=>'form-horizontal','files'=>true))}}
				{{Form::hidden('id',$post->id)}}
				<div class="form-group">
					{{Form::label('title','Tiêu đề',array('class'=>'col-sm-3 control-label no-padding-right'))}}
					<div class="col-sm-9">
						{{Form::text('title',$post->title,array('class'=>'col-xs-10 col-sm-5','placeholder'=>'Title'))}}
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						{{Form::textarea('description',$post->description,array('class'=>'col-xs-10 col-sm-5','placeholder'=>'Description'))}}
					</div>
				</div>
				<div class="form-group">
					{{Form::label('content','Nội dung',array('class'=>'col-sm-3 control-label no-padding-right'))}}
					<div class="col-sm-9">
						{{Form::textarea('content',$post->content,array('class'=>'col-xs-10 col-sm-5','placeholder'=>'Content','id'=>'content'))}}
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="col-xs-6 col-md-3">
							<img src="{{asset($post->thumbnail)}}" class="thumbnail blah" width="120px" />
						</div>
						<div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="col-xs-6 col-md-3">
							<img src="{{asset($post->slider)}}" class="thumbnail" width="180px" />
						</div>
						<div>
							{{Form::file('slider')}}
						</div>
